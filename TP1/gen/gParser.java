...
public class gParser extends Parser {
	...
	public static class ListaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof gVisitor ) return ((gVisitor<? extends T>)visitor).visitLista(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ListaContext lista() throws RecognitionException {
		...
		try {
			...
			setState(15);
			match(T__0);
			System.out.println("Tamanho da lista : " + comprimentoLista);
			                     ...
			                     System.out.println("A média dos núemros presentes é:" +(soma/quantiNujmeros));
	...
	public static class ElemsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof gVisitor ) return ((gVisitor<? extends T>)visitor).visitElems(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ElemContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof gVisitor ) return ((gVisitor<? extends T>)visitor).visitElem(this);
			else return visitor.visitChildren(this);
		}
	}
